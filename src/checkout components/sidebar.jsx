...
const Sidebar = () => {
  return (
    <div className="w-[372px] h-[982px] left-[1px] p-[0px 60px 0px 60px] gap-[48px] border-[0px 1px 0px 0px] bg-[#E1E1E1] border-r-[1px solid #000000] flex flex-col top-0 bottom-0 absolute">
      {/* Sidebar 1 */}
      <div className="w-[276px] h-[488px] p-[60px] gap-[60px] mt-[150px]">
        {/* Sidebar 1A */}
        <div className="w-[276px] h-[48px] p-[10px] gap-[50px] rounded-[10px] bg-[#6769CA] text-white flex flex-row items-center mb-[60px]">
