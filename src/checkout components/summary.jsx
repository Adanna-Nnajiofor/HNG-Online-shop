...
const Summary = () => {
  ...
  return (
    <div className="w-[460px] h-[754px] gap-[43px] flex flex-col">
      <div className="w-[460px] h-[66px] gap-[5px] flex flex-row justify-between">
      ...
      <div className="w-[460px] h-[645px] p-[11px] gap-[10px] rounded-[30px] bg-[#F2F2F7] items-center justify-center flex flex-col">
        <div className="w-[386px] h-[386px] gap-[20px] flex flex-col">
        ...
        <div className="w-[385px] h-[204px] p-[20px 0px] gap-[40px] border-[1px 0px 0px 0px] border-t-[1px solid #000000] flex flex-col items-center justify-between">
          <div className="flex flex-row justify-between items-center gap-[100px]">
            <div className="flex">
              <FaCheck size={24} /> {/* Example usage of FaCheck icon */}
              <p className="font-family-Inter text-[24px] font-bold leading-[28px] text-[#6B6B6B]">
                Total
              </p>
            </div>

            <div className="w-[173px] h-[64px] gap-[0px] flex flex-col items-end">
          ...
          <button className="w-[385px] h-[60px] p-[12px 40px] gap-[10px] rounded-[30px] bg-[#272971] text-white">
            Proceed to Payment
          </button>
        </div>
      </div>
