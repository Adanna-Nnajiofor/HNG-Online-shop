...
const HeroSection = () => {
  return (
    <section id="home" className="w-full items-center justify-center flex">
      <div className="flex flex-col py-8 px-6 lg:px-20 gap-6 rounded-lg max-w-[1512px]  lg:flex-row lg:mt-10">
        {/* Hero1 */}
        <div className="w-full lg:w-[656px] h-auto gap-6  text-[#0C092A] flex flex-col">
          ...
          <button className=" w-[219px] lg:w-[219px] h-[60px] px-6 bg-[#1A1B4B] text-white rounded-[30px]">
            Get started
          </button>
        </div>

        {/* Hero2 */}
        <div className="w-full lg:w-[640px] h-auto px-6 py-8 lg:px-10 lg:py-4 gap-4 rounded-lg bg-[#5A19654D]">
          <img
            src={heroImage}
            alt="Hero"
