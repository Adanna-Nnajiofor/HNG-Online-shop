...
const Footer = () => {
  return (
    <footer className="w-full bg-[#1A1B4B] mt-10 justify-center flex items-center">
      <div className="w-full max-w-[1512px] mx-auto flex flex-col gap-6 justify-between items-center px-6 lg:px-0">
        <div className="flex flex-col lg:flex-row w-full items-center justify-between px-[20px] lg:mt-10 lg:px-[50px]">
          {/* Footer Text */}
          ...
          <div className="flex flex-col gap-2 mt-2 lg:mt-0">
            ...
            <div className="flex items-center gap-2 lg:gap-4 bg-[#1A1B4B] rounded-md p-2 lg:p-3 mt-2 lg:mt-8">
        ...
        {/* Border */}
        <div className="w-full lg:w-[1300px] h-0 border-t-2 border-[#D9DAF2] opacity-50 mt-6 lg:mt-8"></div>

        {/* Footer Below */}
        <div className="flex flex-col lg:flex-row justify-between w-full lg:w-[1180px] mt-4 lg:mt-6 pb-4 lg:pb-6">
